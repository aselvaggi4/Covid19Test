...
<div class="input-group">
  <div class="form-outline">
    ...
    <input class="form-control bordo-data" name="citta" id="citta" type="text" placeholder="Città" aria-label="citta" pattern="[A-Za-z]{1,}" oninvalid="setCustomValidity('Formato non valido')" required>
